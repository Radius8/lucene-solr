...
public final class Version {
   ...
   * @deprecated (7.1.1) Use latest
   */
  @Deprecated
  public static final Version LUCENE_7_1_0 = new Version(7, 1, 0);

  /**
   * Match settings and bugs in Lucene's 7.1.1 release.
   * <p>
   * Use this to get the latest &amp; greatest settings, bug
   * fixes, etc, for Lucene.
   */
  public static final Version LUCENE_7_1_1 = new Version(7, 1, 1);
   ...
   * in your application.
   */
  public static final Version LATEST = LUCENE_7_1_1;
